...
public class SModulosJpaController implements Serializable {
    ...
    public SModulosJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(SModulos SModulos) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findSModulos(SModulos.getIdModulo()) != null) {
                throw new PreexistingEntityException("SModulos " + SModulos + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
